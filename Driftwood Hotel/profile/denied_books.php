    ...
    <div class="dashboard">
        <aside class="sidebar">
            ...
            <nav class="menu">
                ...
                <hr>
                <a href="denied_books.php" class="menu-item active">Denied Books</a>
                <hr>
            </nav>
        </aside>
            ...
            <!-- Table Container -->
                    ...
                    <div class="table-container">
                        ...
                        <table border="1">
                            ...
                            <tbody>
                                <?php if (!empty($deniedBookings)): ?>
                                    <?php foreach ($deniedBookings as $row): ?>
                                        <tr>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="11">No denied bookings.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
